...
=======
            <strong>A</strong>. El gimnasio recopilará datos personales de los
            usuarios durante el proceso de inscripción y durante el uso de los
            servicios ofrecidos.
            <br /> <strong>B</strong>. Los datos personales recopilados pueden
            incluir, entre otros, nombre, dirección, número de teléfono,
            dirección de correo electrónico, fecha de nacimiento y datos de
            salud relevantes.
          </p>
          <h3>USO DE DATOS PERSONALES</h3>
          <p>
            <strong>A</strong>. Los datos personales recopilados se utilizarán
            exclusivamente para los fines relacionados con la prestación de
            servicios por parte del gimnasio.
            <br /> <strong>B</strong>. Estos fines pueden incluir, entre otros,
            la administración de la membresía, la comunicación con los usuarios,
            la programación de actividades y el seguimiento del progreso físico.
          </p>
          <h3>PROTECCIÓN DE DATOS</h3>
          <p>
            <strong>A</strong>. El gimnasio implementará medidas de seguridad
            apropiadas para proteger los datos personales de los usuarios contra
            acceso no autorizado, divulgación o alteración.
            <br /> <strong>B</strong>. Se aplicarán procedimientos y políticas
            internas para garantizar la confidencialidad y seguridad de los
...
<<<<<<< HEAD
          ...
          <p>
            ...
            proporcionados
=======
            <strong>A</strong>. El gimnasio no divulgará los datos personales de
            los usuarios a terceros sin su consentimiento expreso, a menos que
            sea requerido por ley o por una orden judicial.
            <br /> <strong>B</strong>. En caso de ser necesario compartir
            información con terceros proveedores de servicios (por ejemplo,
            procesadores de pagos), se tomarán medidas para garantizar la
            confidencialidad y seguridad de los datos personales.
          </p>
          <h3>DERECHOS DE LOS USUARIOS</h3>
          <p>
            <strong>A</strong>. Los usuarios tienen derecho a acceder, corregir,
            actualizar o eliminar sus datos personales almacenados por el
            gimnasio.
            <br /> <strong>B</strong>. Los usuarios pueden ejercer estos
            derechos enviando una solicitud por escrito al gimnasio, según los
            canales de comunicación proporcionados
>>>>>>> remotes/origin/rama_seba
          </p>
